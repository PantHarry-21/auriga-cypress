// cypress/e2e/roles/AccountantCRM.cy.js
//
// Permissions test suite for the Accountant (CRM) role.
// Verified against the RBAC Matrix screenshots.

import { getPage } from '../../support/pages';

const ROLE_KEY = 'accountant_crm';

const ALLOWED_PERMISSIONS = [
  { module: 'Home Page', key: 'dashboard', rights: { create: false, read: true, update: false, delete: false, approve: false } },
  ...
  { module: 'Credit approval', key: 'crm_credit_approval', rights: { create: false, read: true, update: true, delete: false, approve: true } },
  ...
  { module: 'Generate PO', key: 'purchase_indent_purchase_order', rights: { create: false, read: true, update: false, delete: false, approve: false } }
];
...
describe('Permissions — Accountant CRM', () => {
