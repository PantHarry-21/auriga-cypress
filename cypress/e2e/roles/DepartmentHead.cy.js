// cypress/e2e/roles/DepartmentHead.cy.js
//
// Permissions test suite for the Department Head role.
// Verified against the RBAC Matrix screenshots.

import { getPage } from '../../support/pages';

const ROLE_KEY = 'department_head';
...
const ALLOWED_PERMISSIONS = [
  ...
  { module: 'Ticket', key: 'support_ticket', rights: { create: true, read: true, update: true, delete: false, approve: true } },
  { module: 'Indent Manage', key: 'purchase_indent_indent', rights: { create: true, read: true, update: true, delete: false, approve: true } },
...
describe('Permissions — Department Head', () => {
