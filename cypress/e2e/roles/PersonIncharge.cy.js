// cypress/e2e/roles/PersonIncharge.cy.js
//
// Permissions test suite for the Person Incharge role.
// Verified against the RBAC Matrix screenshots.

import { getPage } from '../../support/pages';

const ROLE_KEY = 'person_incharge';
...
const ALLOWED_PERMISSIONS = [
  ...
  { module: 'Reports To Be Signed', key: 'reports_sign', rights: { create: false, read: true, update: false, delete: false, approve: true } }
];
...
describe('Permissions — Person Incharge', () => {
