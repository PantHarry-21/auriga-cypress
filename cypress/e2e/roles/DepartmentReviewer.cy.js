// cypress/e2e/roles/DepartmentReviewer.cy.js
//
// Permissions test suite for the Department Reviewer role.
// Verified against the RBAC Matrix screenshots.

import { getPage } from '../../support/pages';

const ROLE_KEY = 'department_reviewer';
...
const ALLOWED_PERMISSIONS = [
  ...
  { module: 'STP QA', key: 'qdms_stp_qa_management', rights: { create: false, read: true, update: false, delete: false, approve: false } },
  ...
  { module: 'Standard Operating Procedure', key: 'qdms_department_sop', rights: { create: false, read: true, update: false, delete: false, approve: false } },
  { module: 'My Complete Test', key: 'reports_coc_my_complete_test', rights: { create: true, read: true, update: true, delete: false, approve: true } },
  { module: 'My Pending Test', key: 'reports_coc_my_pending_test', rights: { create: true, read: true, update: true, delete: false, approve: true } },
...
describe('Permissions — Department Reviewer', () => {
