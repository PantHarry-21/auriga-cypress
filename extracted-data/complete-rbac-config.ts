...
export const ROLE_MODULE_PERMISSIONS: RoleModulePermissionMap = {
  ...
  [ROLES.ADMIN]: {
    ...
    [MODULES.BATCH_MANAGEMENT]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE, PERMISSIONS.EDIT, PERMISSIONS.DELETE, PERMISSIONS.APPROVE],
    ...
    [MODULES.TREND_ANALYSIS]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE, PERMISSIONS.EDIT, PERMISSIONS.DELETE, PERMISSIONS.APPROVE, PERMISSIONS.EXPORT],
  ...
  [ROLES.BOOKING_PERSONNEL]: {
    ...
    [MODULES.BATCH_MANAGEMENT]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE],
  ...
  [ROLES.MASTER_PERSONNEL]: {
    ...
    [MODULES.PURCHASE_ORDERS]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE],
    [MODULES.RECEIVING_INSPECTION]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE],
  },
  ...
  [ROLES.DEPARTMENT_HEAD]: {
    ...
    [MODULES.TEST_BOOKING]: [PERMISSIONS.VIEW],
    [MODULES.TEST_EXECUTION]: [PERMISSIONS.VIEW],
    [MODULES.BATCH_MANAGEMENT]: [PERMISSIONS.VIEW, PERMISSIONS.APPROVE],
    [MODULES.RESULT_APPROVAL]: [PERMISSIONS.VIEW, PERMISSIONS.APPROVE],
    [MODULES.REPORT_GENERATION]: [PERMISSIONS.VIEW, PERMISSIONS.APPROVE],
    [MODULES.QUALITY_CONTROL]: [PERMISSIONS.VIEW],
  ...
  [ROLES.PERSON_IN_CHARGE]: {
    ...
    [MODULES.TEST_EXECUTION]: [PERMISSIONS.VIEW],
    [MODULES.BATCH_MANAGEMENT]: [PERMISSIONS.VIEW],
    [MODULES.INVENTORY_MANAGEMENT]: [PERMISSIONS.VIEW],
  ...
  [ROLES.QUALITY_PERSONNEL]: {
    [MODULES.DASHBOARD]: [PERMISSIONS.VIEW],
    [MODULES.GENERIC_MASTER]: [PERMISSIONS.VIEW],
    [MODULES.TEST_EXECUTION]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE],
    [MODULES.BATCH_MANAGEMENT]: [PERMISSIONS.VIEW, PERMISSIONS.CREATE],
