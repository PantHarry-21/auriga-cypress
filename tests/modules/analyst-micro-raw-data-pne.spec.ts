/**
 * Micro Raw Data Enter — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/analyst/micro-raw-data
 * Role : admin
...
const URL = '/dashboard/analyst/micro-raw-data';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-ANALYST_MICRO_RAW_DATA-PNE] Micro Raw Data Enter — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('micro-raw-data');
    });
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by Batch Code / Description"]').first();
