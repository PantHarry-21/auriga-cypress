...
test.describe("[MODULE-012] Cancel Sample", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/cancel.{0,1}batch/i);
    });
   ...
   *   page.getByRole("textbox", { name: "Enter Sample Tracking No. or Sample Request No." })
