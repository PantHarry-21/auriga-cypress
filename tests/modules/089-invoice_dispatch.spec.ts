/**
 * Invoice Dispatch — E2E Test Suite
 * URL  : /dashboard/invoice-dispatch
 * Role : admin
 */
import { test, expect } from '../global-setup';
import { stubStimulsoft, loginAs } from '../helpers/commands';

const URL = "/dashboard/invoice-dispatch";
const LAB = 'Arbro - Delhi';

test.describe("[MODULE-089] Invoice Dispatch", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/invoice.{0,1}dispatch/i);
    });
   ...
   *   page.getByRole("button", { name: "Assigned" })
   *   page.getByRole("button", { name: "Courier Dispatched" })
