/**
 * View Sample for Updation — E2E Test Suite
...
test.describe("[MODULE-054] View Sample for Updation", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/view.{0,1}sample.{0,1}updation/i);
    });
...
}); // describe View Sample for Updation
