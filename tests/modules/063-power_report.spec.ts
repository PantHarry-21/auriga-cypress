...
test.describe("[MODULE-063] Power Report", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/power.{0,1}report/i);
    });
   ...
   *   page.getByRole("button", { name: "Manage Reports" })
