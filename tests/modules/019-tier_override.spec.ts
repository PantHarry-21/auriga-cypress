/**
 * Tier Override — E2E Test Suite
 * URL  : /dashboard/profile/tier-override
 * Role : admin
 */
import { test, expect } from '../global-setup';
import { stubStimulsoft, loginAs } from '../helpers/commands';

const URL = "/dashboard/profile/tier-override";
const LAB = 'Arbro - Delhi';

test.describe("[MODULE-019] Tier Override", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/tier.{0,1}override/i);
    });
   ...
   *   page.getByRole("button", { name: "Quick Sample Entry" })
