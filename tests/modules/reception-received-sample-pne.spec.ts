/**
 * Reception Received Sample — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
const URL = '/dashboard/reception/received-sample';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-RECEPTION_RECEIVED_SAMPLE-PNE] Reception Received Sample — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('received-sample');
    });
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by client name or TRF number"]').first();
