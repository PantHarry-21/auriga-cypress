/**
 * Signatory Setup — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
test.describe('[MODULE-TEMPLATES-PNE] Signatory Setup — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P05 "Add Mapping" action is present', async ({ page }) => {
      await expect(page.locator('button:has-text("Add Mapping")').first()).toBeVisible({ timeout: 15000 });
    });
  });
