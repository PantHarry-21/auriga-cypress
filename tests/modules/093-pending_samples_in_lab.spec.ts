/**
 * Pending Samples in Lab — E2E Test Suite
...
test.describe("[MODULE-093] Pending Samples in Lab", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/lab.{0,1}pending.{0,1}samples/i);
    });
...
}); // describe Pending Samples in Lab
