/**
 * Final Report Upload — E2E Test Suite
...
test.describe("[MODULE-051] Final Report Upload", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/final.{0,1}report.{0,1}upload/i);
    });
   ...
   *   page.getByRole("textbox", { name: "Enter sample request number..." })
