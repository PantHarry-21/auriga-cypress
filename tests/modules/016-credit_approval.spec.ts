/**
 * Credit approval — E2E Test Suite
...
test.describe("[MODULE-016] Credit approval", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/credit.{0,1}approval/i);
    });
   ...
   *   page.getByRole("button", { name: "Sent Back2" })
   *   page.getByRole("button", { name: "Approved Clients4027" })
