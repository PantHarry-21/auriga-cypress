/**
 * Invoice List — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
const URL = '/dashboard/invoices';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-INVOICES-PNE] Invoice List — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by invoice no or company name…"]').first();
    ...
    test('TC-P05 "+ Generate E-Invoice" action is present', async ({ page }) => {
