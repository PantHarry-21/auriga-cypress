/**
 * Draft Invoices — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/invoices/drafts
 * Role : admin
...
const URL = '/dashboard/invoices/drafts';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-INVOICES_DRAFTS-PNE] Draft Invoices — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by draft no or company name…"]').first();
    ...
    test('TC-P05 "+ Create Invoice" action is present', async ({ page }) => {
