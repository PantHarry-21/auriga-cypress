/**
 * Assign Coordinator — E2E Test Suite
...
test.describe("[MODULE-018] Assign Coordinator", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/assign.{0,1}coordinator/i);
    });
   ...
   *   page.getByRole("button", { name: "Pending 362" })
   *   page.getByRole("button", { name: "Assigned 17508" })
