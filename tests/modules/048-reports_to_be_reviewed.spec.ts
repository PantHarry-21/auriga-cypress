/**
 * Reports To Be Reviewed — E2E Test Suite
...
test.describe("[MODULE-048] Reports To Be Reviewed", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/to.{0,1}be.{0,1}reviewed/i);
    });
...
}); // describe Reports To Be Reviewed
