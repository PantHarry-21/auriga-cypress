/**
 * Micro Enter Result — E2E Test Suite
...
test.describe("[MODULE-067] Micro Enter Result", () => {
  ...
  test.describe('1. Page Load', () => {
    ...
    test('TC-002 page URL contains expected path segment', async ({ page }) => {
      ...
      expect(page.url()).toMatch(/micro.{0,1}enter.{0,1}result/i);
    });
