/**
 * Equipment Registration — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
test.describe('[MODULE-EQUIPMENT_EQUIPMENT-PNE] Equipment Registration — Positive/Negative/Edge', () => {
