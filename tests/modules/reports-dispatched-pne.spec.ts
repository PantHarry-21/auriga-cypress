/**
 * Dispatched — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
const URL = '/dashboard/reports/dispatched';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-REPORTS_DISPATCHED-PNE] Dispatched — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('dispatched');
    });
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by sample number, product name, or generic product..."]').first();
