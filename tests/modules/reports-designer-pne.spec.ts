/**
 * Report Designer — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/reports/designer
 * Role : admin
...
const URL = '/dashboard/reports/designer';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-REPORTS_DESIGNER-PNE] Report Designer — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P05 "New Template" action is present', async ({ page }) => {
