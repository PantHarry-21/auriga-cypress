/**
 * Multi report — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/reports/multi-report
 * Role : admin
...
const URL = '/dashboard/reports/multi-report';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-REPORTS_MULTI_REPORT-PNE] Multi report — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('multi-report');
    });
