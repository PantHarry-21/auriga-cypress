/**
 * Create Invoice — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
...
const URL = '/dashboard/invoices/create';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-INVOICES_CREATE-PNE] Create Invoice — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search client by name (min 3 chars)…"]').first();
    ...
    test('TC-P05 "New Invoice" action is present', async ({ page }) => {
