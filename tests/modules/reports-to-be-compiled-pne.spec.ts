/**
 * Reports To Be Compiled — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/reports/to-be-compiled
 * Role : admin
...
const URL = '/dashboard/reports/to-be-compiled';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-REPORTS_TO_BE_COMPILED-PNE] Reports To Be Compiled — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('to-be-compiled');
    });
    ...
    test('TC-P04 list search accepts input (or is gated until filters applied)', async ({ page }) => {
      const search = page.locator('input[placeholder="Search by sample request number, product, or client name..."]').first();
