/**
 * Allot Sample to Dept — Positive / Negative / Edge Case Suite (auto-generated from live prod crawl 2026-07-20)
 * URL  : /dashboard/allot-sample
 * Role : admin
...
const URL = '/dashboard/allot-sample';
const LAB = 'Arbro - Delhi';

test.describe('[MODULE-ALLOT_SAMPLE-PNE] Allot Sample to Dept — Positive/Negative/Edge', () => {
  ...
  test.describe('Positive', () => {
    ...
    test('TC-P02 URL reflects the module route', async ({ page }) => {
      expect(page.url()).toContain('allot-sample');
    });
